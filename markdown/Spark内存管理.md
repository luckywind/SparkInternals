...
<img src="../PNGfigures/spark_on_heap_memory_iteblog.png" alt="spark_on_heap_memory_iteblog" style="zoom: 50%;" />
...
由于没有设置 `spark.memory.fraction` 和 `spark.memory.storageFraction` 参数，我们可以看到 Spark UI 关于 Storage Memory 的显示如下：![spark_memory_usage2](../PNGfigures/spark_memory_usage2.png)
